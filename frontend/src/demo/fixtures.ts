...
//   V3__product.sql                    brand 더샘, 3 root categories, sunscreen + 2 options
...
export const DEMO_BRANDS: Record<number, { name: string; slug: string }> = {
  1: { name: '더샘', slug: 'thesecret' },
  2: { name: '라운드랩', slug: 'roundlab' },
  3: { name: '닥터지', slug: 'drg' },
  4: { name: '클리오', slug: 'clio' },
  5: { name: '메디힐', slug: 'mediheal' },
  6: { name: '아로마티카', slug: 'aromatica' },
  7: { name: '브링그린', slug: 'bringgreen' },
}
...
const V15_ROWS: Row[] = [
  [2, '자작나무 수분 토너 500ml', '건조한 피부에 산뜻하게 흡수되는 대용량 수분 토너입니다.', 28000, 22400, 1, 'roundlab-birch-toner-500ml.png'],
  [3, '레드 블레미쉬 진정 크림 70ml', '민감한 피부를 촉촉하게 진정시키는 데일리 수분 크림입니다.', 36000, 25200, 1, 'drg-red-blemish-cream-70ml.png'],
  [7, '티트리 시카 트러블 세럼 30ml', '티트리와 시카 성분으로 번들거림 없이 케어하는 집중 세럼입니다.', 24000, 16800, 1, 'bringgreen-teatree-cica-serum-30ml.png'],
  [1, '약산성 버블 클렌징 폼 150ml', '풍성한 버블로 피부 장벽 부담을 줄인 약산성 클렌징 폼입니다.', 15000, 9900, 1, 'the-saem-low-ph-bubble-cleansing-foam-150ml.png'],
  [5, '콜라겐 에센셜 마스크팩 10매', '피부 탄력과 윤기를 위한 에센스 듬뿍 시트 마스크 세트입니다.', 22000, 14900, 1, 'mediheal-collagen-mask-10ea.png'],
  [4, '킬래쉬 워터프루프 마스카라 블랙', '번짐 없이 또렷한 속눈썹을 연출하는 워터프루프 마스카라입니다.', 18000, 12600, 2, 'clio-kill-lash-waterproof-mascara-black.png'],
  [4, '쉬폰 블러 립 틴트 로즈', '가볍게 밀착되는 로즈 컬러의 소프트 블러 립 틴트입니다.', 16000, 11200, 2, 'clio-chiffon-blur-lip-tint-rose.png'],
  [4, '커버핏 쿠션 파운데이션 21N', '얇게 밀착되면서 자연스러운 커버를 돕는 데일리 쿠션입니다.', 32000, 25600, 2, 'clio-coverfit-cushion-foundation-21n.png'],
  [6, '로즈마리 두피 쿨링 샴푸 500ml', '두피를 산뜻하게 씻어내는 로즈마리 쿨링 샴푸입니다.', 21000, 16800, 3, 'aromatica-rosemary-scalp-cooling-shampoo-500ml.png'],
  [6, '퍼퓸 바디워시 피그 480ml', '은은한 무화과 향으로 샤워 후 잔향을 남기는 바디워시입니다.', 19000, 15200, 3, 'aromatica-perfume-bodywash-fig-480ml.png'],
  [1, '시어버터 핸드크림 3종 세트', '휴대하기 좋은 보습 핸드크림 3종 기획 세트입니다.', 12000, 8900, 3, 'the-saem-sheabutter-handcream-3set.png'],
  [3, '남성 올인원 플루이드 150ml', '스킨과 로션 단계를 한 번에 끝내는 산뜻한 남성 올인원입니다.', 26000, 19500, 1, 'drg-men-all-in-one-fluid-150ml.png'],
]
...
export const DEMO_PRODUCTS: DemoProduct[] = [
  {
    ...
    categoryIds: [1, 2, 3],
    images: [
      img('the-saem-kids-suncream-spf50-thumb.png'),
      img('the-saem-kids-suncream-detail-1.png'),
      img('the-saem-kids-suncream-detail-2.png'),
    ],
    options: [
